...
class TestMovieListView(TestCase):
    def setUp(self):
        self.movie = Movie.objects.create(title="Test Movie", year="2019", imdb=8.0, genre="Fantastic")
        self.client = Client()
...
class TestMovieSortImdbView(TestCase):
    def setUp(self):
        self.movie1 = Movie.objects.create(title="Test Movie", year=2019, imdb=4.0, genre="Fantastic")
        self.movie2 = Movie.objects.create(title="Test Movie 2", year=2020, imdb=6.0, genre="Drama")
        self.movie3 = Movie.objects.create(title="Test Movie 3", year=2020, imdb=2.0, genre="Drama")
        self.client = Client()
